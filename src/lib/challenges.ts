...
export const CHALLENGES: TripChallenge[] = [
  ...
  // ──────────────────────────────────────────────────────────────
  {
    ...
    locations: [
      ...
      { id: 'cet-04', name: 'Kakabeka Falls, ON', address: 'Kakabeka Falls Provincial Park, Ontario', lat: 48.4022, lng: -89.6233, type: 'waypoint' },
  ...
  // ──────────────────────────────────────────────────────────────
  {
    ...
    locations: [
      ...
      { id: 'eos-05', name: 'Georgetown, TX', address: 'Blue Hole Regional Park, Georgetown, Texas', lat: 30.6332, lng: -97.6777, type: 'waypoint' },
      { id: 'eos-06', name: 'Bend, TX', address: 'Colorado Bend State Park, Bend, Texas', lat: 31.0491, lng: -98.4363, type: 'waypoint' },
...
const EXTENDED_CHALLENGES: TripChallenge[] = [
  ...
  // 7 days · ~5,836 km · ~71h driving · 4 travelers · 2 drivers
  {
    ...
    locations: [
      ...
      { id: 'cete-04', name: 'Kakabeka Falls, ON', address: 'Kakabeka Falls Provincial Park, Ontario', lat: 48.4022, lng: -89.6233, type: 'waypoint' },
