/**
 * fuel-stops.ts — Strategic fuel-stop planning + stop metadata
 *
 * Exports:
 *   - StrategicFuelStop interface
 *   - calculateStrategicFuelStops()  — geometry-based stop placement
 *   - calculateHumanFuelCosts()      — conservative "full-tank" cost model
 *   - STOP_DURATIONS                 — duration presets in minutes
 *   - STOP_LABELS                    — display labels for stop types
 */
