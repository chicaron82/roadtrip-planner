...
<body>
  ...
  <p style="text-align: center; color: #6b7280; margin-top: 40px;">
    Generated by The Experience Engine on ${new Date().toLocaleDateString()}
  </p>
</body>
</html>`;
            ...
            <button
              onClick={() => {
                ...
                const template = {
                  ...
                  importInstructions: 'Load this template in The Experience Engine to follow the same route!',
                };
